...
def fit(model: Module, encoder: Module, optimiser: Optimizer, loss_fn: Callable, epochs: int, dataloader: DataLoader,
    ...
    for epoch in range(1, epochs+1):
        ...
        for batch_index, batch in enumerate(dataloader):
            ...
            loss, y_pred = fit_function(
                model, encoder, optimiser, loss_fn, x, y, **fit_function_kwargs)
